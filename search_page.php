...
<section class="search-form">
    <form action="" method="POST">
        ...
        <select name="type" id="" class="box" required>
        ...
        <select name="concern" id="" class="box" required>
            <option value="" disabled selected>Select your skin concern</option>
            <option value="Acne & Scarring">Acne & Scarring</option>
            <option value="Dull & Uneven Skin Tones">Dull & Uneven Skin Tones</option>
   ...
   <div class="box-container">
      ...
      <?php
        if(isset($_POST['search_btn'])){
         ...
         $select_products = mysqli_query($conn, "SELECT p.* FROM products p LEFT JOIN skin_type t ON p.product_id=t.product_id LEFT JOIN skin_concern c ON p.product_id=c.product_id WHERE t.skin_type_name LIKE '%{$type}%' AND c.skin_concern_name LIKE '%{$concern}%'") or die('query failed');
